...
const env = import.meta.env.VITE_MERCADOPAGO_PUBLIC_KEY;
initMercadoPago(env);

const Index1 = ({ membresia_id, auth }) => {
    const sendDataToLaravel = (data) => {
        post("/procesar-pago", data, {
            onSuccess: (page) => {
            ...
            onError: (errors) => {
                ...
                console.error("Hubo un error al procesar el pago", errors);
            },
        });
    };
    // console.log(env);
    ...
    const handleSubmit = (e) => {
        ...
        const datos = { nombre: "Maria", monto: 1500 };
        sendDataToLaravel(datos);
    };
    // useEffect(() => {
