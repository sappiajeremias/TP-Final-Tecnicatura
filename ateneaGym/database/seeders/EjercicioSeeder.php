...
class EjercicioSeeder extends Seeder {
    ...
    public function run(): void {
        //
        $ejercicio1 = Ejercicio::create(['nombre' => 'Press Banco Plano', 'descripcion' => "Con la barra olímpica, levantar y bajar a la altura del centro del pecho.2", 'musculo' => 'Pectorales']);
